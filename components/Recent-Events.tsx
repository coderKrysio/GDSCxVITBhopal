        ...
        <div className="components">
            ...
            <div className="recent--evt">
                <div>
                    ...
                    <span className="color--card yellow light--mode" style={{'--i':1,'--div-color':'#FFD64F'}}></span>
                </div>
                ...
                <div>
                    ...
                    <span className="color--card green light--mode" style={{'--i':3.75,'--div-color':'#3AA959'}}></span>
                </div>
                ...
                <div>
                    ...
                    <span className="color--card blue light--mode" style={{'--i':6.5,'--div-color':'#2C96FF'}}></span>
                </div>
            </div>
